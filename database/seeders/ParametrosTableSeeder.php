...
class ParametrosTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('parametros')->insert(['ianio'=>'2025','iultimo_folio'=>'0','cleyenda_anual_oficios'=>'"2025 Año de la Mujer Indígena"','iestatus'=>1,'iid_usuario'=>1,'created_at'=>Carbon::now()->format('Y-m-d H:i:s')]);
    }
}
