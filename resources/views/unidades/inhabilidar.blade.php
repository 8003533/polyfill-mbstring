...
@section('panel')
<form method="POST" action="{{ url('/unidades/actualizar') }}" id="formInhabilitarUnidad">
    @csrf
    <input type="hidden" name="id_unidad" id="id_unidad" value="{{ $unidad->id_unidad }}">
